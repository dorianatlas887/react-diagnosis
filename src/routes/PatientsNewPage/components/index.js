...
/**
 * @name PatientsNewPageComponents
 *
 *
 * @param {Object}   user
 ...
 * @returns {JSX}
 */
class PatientsNewPageComponents extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div className='PatientsNewPage'>
        <Grid container justify='flex-end'>
          <Grid item>
            <Button variant='contained' color='primary' className={classes.button} onClick={this.handleRedirect('/patients/')}>
              {literals.save}
            </Button>
          </Grid>
        </Grid>
...
export default withStyles(styles)(PatientsNewPageComponents);
